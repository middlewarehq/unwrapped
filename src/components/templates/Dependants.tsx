    ...
    return (
      <div tw="flex flex-col items-center w-full">
        ...
        <div tw="flex w-full">
          <div
            tw={
              'flex text-xs relative mr-1 top-4 p-1 bg-blue-300 rounded-lg items-center'
            }
          >
            {attachedNodes[0]}
          </div>
        ...
        <div
          tw={
            'my-4 flex relative top-4 p-1 mx-1 bg-blue-200 rounded-full items-center'
          }
        >
          <img
    ...
    return (
      <div tw="flex flex-col items-center w-full">
        ...
        <div tw="flex w-full justify-end">
          <div
            tw={
              'flex text-xs relative top-4 ml-1 p-1 bg-blue-300 rounded-lg items-center'
            }
          >
            {attachedNodes[1]}
          </div>
